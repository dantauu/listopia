...
const catalogIcon = ({ isActive }: { isActive: boolean }) => (
	<svg width="40px" height="40px" viewBox="0 0 48 48" fill="none" xmlns="http://wwww3.	org/2000/svg" transform="rotate(0) scale(1, 1)">
...
const profileIcon = ({ isActive }: { isActive: boolean }) => (
	<svg width="40px" height="40px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0) scale(1, 1)">
